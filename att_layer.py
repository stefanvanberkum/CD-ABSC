...
def mlp_attention_layer2(inputs, length, n_hidden, l2_reg, random_base, layer_id=1):
    """
    :param inputs: batch * max_len * n_hidden
    :param length: batch * 1
    :param n_hidden:
...
def triple_attention_layer(input1, input2, input3, length, n_hidden, l2_reg, random_base, layer_id=1):
    """
    :param input1: batch * max_len * n_hidden
    :param input2: batch * max_len * n_hidden
    :param input3: batch * max_len * n_hidden
    :param length: batch * 1
    :param n_hidden:
    :param l2_reg:
    :param random_base:
